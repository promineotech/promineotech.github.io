...
jQuery(document).ready(function() {
    ...
    */
	...
	$('.backstretch img').css("filter", "blur(3px)");
	
	$('.section-1-container').backstretch("assets/img/backgrounds/1.jpg");
	$('.section-2-container').backstretch("assets/img/backgrounds/2.jpg");
	$('.section-3-container').backstretch("assets/img/backgrounds/3.jpg");
    $('.section-4-container').backstretch("assets/img/backgrounds/4.jpg");
	$('.section-5-container').backstretch("assets/img/backgrounds/5.jpg");
